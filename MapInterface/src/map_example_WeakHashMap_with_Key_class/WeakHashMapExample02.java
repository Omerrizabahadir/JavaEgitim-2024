package map_example_WeakHashMap_with_Key_class;
...
public class WeakHashMapExample02 {
    public static void main(String[] args) {
        ...
        //Key lerin altını çiziyor import java. security yi kapat.Map içindeki Key in kendi class'ını yapabiliriz
        //Key'i oradan gösteriyorum
